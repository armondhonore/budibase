...
**Live:** [https://relaxed-weasel-budibase.cloud.nexlayer.ai](https://relaxed-weasel-budibase.cloud.nexlayer.ai)  
...
**budibase** is deployed on [Nexlayer](https://nexlayer.ai) — a container-native
...
application:
  ...
  pods:
  - name: app
    image: mirror.gcr.io/budibase/budibase:latest
    path: /
    servicePorts:
    - 80
    resources:
    ...
    vars:
      ...
      INTERNAL_API_KEY: "a1b2c3d4e5f6a1b2"
      BB_ADMIN_USER_EMAIL: "armond@nexlayer.com"
      BB_ADMIN_USER_PASSWORD: "nexlayer2024"
    volumes:
    - name: budibase-data
      mountPath: /data
      size: 10Gi
